...
## Current snapshot (2026-09-08 05:08 UTC)

| Metric | Value |
|--------|------:|
| Newdrop merges (7d) | 20 |
| Non-noop cycles/day | 10 today · proj 46.7/day · week_avg 10.0 (bar ≥8) [PASS] |
| Free-desktop agent cap | 8 |
| Theater Active share | 0% (0/2 open) |
| Brain / daemons | CLEAN peer-loop=active improve-loop=active ssh_rc=0 |

Merges: #142 Custom Auth domain deferred residual (#25) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/142); #140 Resend bounce/complaint suppress (#57) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/140); #138 Billing-reconcile nests notify-ledger retry (#53 residual) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/138); #137 Session revoke-all global scope (#100) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/137); #135 Subscriber PII export audit (#73) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/135)
